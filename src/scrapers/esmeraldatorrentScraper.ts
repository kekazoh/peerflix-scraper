...
const SOURCE = 'EsmeraldaTorrent';
const DEFAULT_URL = 'https://esmeraldatorrent.com';

export class EsmeraldatorrentScraper extends Scraper {
...
if (require.main === module) {
  const scraper = new EsmeraldatorrentScraper();
